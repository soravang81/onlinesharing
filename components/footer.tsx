...
export default function Footer () {
    return <div className="w-full xl:px-60 lg:px-40 md:px-20 sm:px-8 px-2 flex flex-col sm:flex-row items-center justify-between gap-2 absolute bottom-8 w-fulll bg-black text-white">
